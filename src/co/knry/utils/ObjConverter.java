...
public class ObjConverter implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5023925105623579466L;
	...
	public ObjConverter(String[] tokens, Logger logger, int linea) {
		this.logger=logger;
		this.valid=true;
		this.linea=linea;
		int validador=0;
